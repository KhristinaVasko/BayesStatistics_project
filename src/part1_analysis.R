...
pair_results <- get_all_pair_results("data/games.csv")
...
model <- stan_model("models/elo_model.stan")
...
ggsave("outputs/part1/rating_plot.png", p1, width = 8, height = 6)
...
ggsave("outputs/part1/rating_densities.png", p2, width = 10, height = 6)
...
ggsave("outputs/part1/superiority_heatmap.png", p3, width = 8, height = 6)
...
save(rating_summary, superiority_matrix, games, stan_data, pair_results,
     file = "outputs/part1/part1_results.RData")
saveRDS(fit, "outputs/part1/part1_fit.rds")